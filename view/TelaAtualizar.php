  ...
  <a href="../index.php"><h5>Voltar</h5></a>
      ...
      <div class="row">
        <div class="input-field col s12">
          ...
          <input id="icon_prefix" name="id" value="<?php echo $id; ?>"type="text" class="validate">
      ...
      <select id="inputState"  name="sexo" class="form-control">
        ...
        <div class="input-field col s12">
          ...
          <input id="icon_sexo" value="<?php echo $cidade; ?>"name="cidade" type="text" class="validate">
          <label for="icon_telephone">Cidade</label>
        </div>
        
              <button class="btn waves-effect waves-light" name="acao" value="atualizar" type="submit" >Salvar
